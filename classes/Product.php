...
<?php
    ...
    class Product
    {
         ...
         * @return bool
         */
        public function showsayur()
        {
            return $this->db->select("SELECT * FROM ecom_product WHERE catid = 9 ORDER BY proid LIMIT 3");
        }
        ...
        {
            return $this->db->select("SELECT * FROM ecom_product WHERE catid = 10 ORDER BY proid LIMIT 3");
        }
