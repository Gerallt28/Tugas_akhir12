                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                        <ul class="nav navbar-nav">
                            ...
                            <?php if (Session::get("userLogin")): ?>
                                <li><a href="profile.php" class="act">Profile</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </nav>
                    ...
                    <div class="col-md-11" id="user-option">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="update.php" aria-controls="profile" role="tab" class="text-center" data-toggle="tab" style="width: 150px;">Profile Update</a>
                            </li>
                                            ...
                                            <tbody>
                                                <?php while ($cart = $userCart->fetch_assoc()): $i++; ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">Rp.<?php echo $cart['price']; ?></td>
                                                        <td class="text-center"><?php echo $cart['quantity']; ?></td>
                                                        <td class="text-center">Rp.<?php echo $cart['quantity']*$cart['price'];?></td>
